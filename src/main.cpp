    ...
    if (length && length > 2 && data[0] == '4' && data[1] == '2') {
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          bool left_impossible = false;
          bool right_impossible = false;
          ...
          std::cout << "data: "<< sensor_fusion.size() << ", " << num_ds << ", " << num_trues << std::endl;
          if(too_close){
            ref_vel -= 0.224;
          ...
          // Lane change
          if (try_lane_change) {
            if ((left_impossible == false) and (lane != 0)) {
              lane = lane - 1;
            }
            else if ((right_impossible == false) and (lane != 2)) {
              lane = lane + 1;
            }
          }
